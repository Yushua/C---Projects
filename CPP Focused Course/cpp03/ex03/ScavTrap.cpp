...
/*   Updated: 2022/09/01 17:57:04 by ybakker       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap()
{
	...
	<< "so your name is " << _colour << _name << RESET << "pretty exspensive for a Scav like you " << std::endl;
}

ScavTrap::ScavTrap(const std::string name) : ClapTrap(name + " Scav") 
{
	_name = name + " Scav ";
	_hp = 100;
	_ep = 50;
	...
	<< "so your name is " << _colour << _name << RESET << " pretty expensive for a Scav like you " << std::endl;
}
...
{
  std::cout << BLUE << _name << " is now in 'Gate Keeper' mode.\n" << RESET<< std::endl;
}
